...
public class MemberRecordVo {
	...
	private String transferOrder;// 转账详情
	...
	@Transient
	private String rechargeDateShow;
	...
	private String phone;// 绑定手机shouji
	...
	public String getRechargeDateShow() {
		return rechargeDateShow;
	}

	public void setRechargeDateShow(String rechargeDateShow) {
		this.rechargeDateShow = rechargeDateShow;
	}
	...
	public MemberRecordVo(String id, String userId, BigDecimal payAccount, Long rechargeDate, String rechargeType, String rechargeWay, String draweeAccountName, String draweeAccount, String currency, String tranfserBank, String remark, String transferOrder, String orderID, String state, String stateDesc, String auditor, Long auditDate, String reskey, String bankFlow, String isDel, Long delTime, String auDate, String rechargeDateShow, String userName, String phone, String tranId,
	                      BigDecimal amount, String condition, Long createDate, String bankcard, String searchStartTime, String searchEndTime, Long startTime, Long endTime, BigDecimal accountBalance, String balanceId, BigDecimal beforeChangBlance, BigDecimal afterChangeBlance, String transactionState) {
		super();
		this.id = id;
		this.userId = userId;
		this.payAccount = payAccount;
