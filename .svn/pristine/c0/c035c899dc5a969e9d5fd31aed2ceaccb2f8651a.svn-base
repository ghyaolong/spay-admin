...
<head>
    <title>添加规则</title>
      <script src="./js/terraceActive/add.js"></script>
...
<body>
    		...
    		<div class="form-group">
	                ...
	                <div class="col-sm-10">
	                 <select id="activeId" name="activeId" type="text" class="form-control"
	                  data-bv-notempty="true" data-bv-notempty-message="活动号不能为空">
	                    <option>请选择</option>
                      </select>  
	                     <!--  <input type="text" class="form-control" name="activeId"
	                      data-bv-notempty="true" data-bv-notempty-message="活动ID不能为空"> -->
	                </div>
	            </div>
	            <div class="form-group">
