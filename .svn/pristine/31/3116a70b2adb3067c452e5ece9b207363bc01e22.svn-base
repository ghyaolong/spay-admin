...
<head>
    <title>分发券购买记录</title>
    <script src="./js/payDispenseRecord/list.js"></script>
</head>
<body>
<!--检索区 -->
        ...
        <form class="form-inline" role="form" id="searchForm">
            <div class="form-group">
                <label class="sr-only" ></label>
               		 标题&nbsp;&nbsp;<input type="text" class="form-control"  placeholder="请输入标题" name="title">
            </div> 
            <div class="form-group">
                <label class="sr-only" ></label>
               		 购买时间&nbsp;&nbsp;<input type="Date"  class="form-control"  placeholder="请输入 购买时间" name="searchStartTime">
               		 <input type="Date"  class="form-control"  placeholder="请输入 购买时间"  name="searchEndTime">
            </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped b-t b-light">
            ...
            <tr>
                ...
                <td>{$T.record.purchaser}</td>
                <td>{$T.record.title}</td>
                <td>{$T.record.buyAmount}</td>
                <td>{$T.record.faceValue}</td>
