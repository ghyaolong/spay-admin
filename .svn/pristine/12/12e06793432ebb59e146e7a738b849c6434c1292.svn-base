    ...
    <div class="panel-body">
        <form class="form-inline" role="form" id="searchForm">
            <div class="form-group">
                <label class="sr-only" ></label>业务号
                <input type="text" class="form-control" placeholder="请输入活动ID" name="bussinessId">
            </div> 
            <div class="form-group">
                <label class="sr-only" ></label>业务描述
                <input type="text" class="form-control"  placeholder="请输入业务号" name="businessDescribe">
            </div> 
    ...
    <div class="table-responsive">
        <table class="table table-striped b-t b-light">
            ...
            <tr>
                ...
                <td>{$T.record.bussinessId}</td>
                <td>{$T.record.businessDescribe}</td>
            </tr>
            {#/for}
            </tbody>
        </table>
