...
function update(resUrl){
	 initForm({
	        lable:'修改规则', 
	        init_url:resUrl,
	        submit_url:'payActive/update.do',
	        serviceName:'payActive'
	    });
}
...
function findById(id){
	initForm({
        lable:'规则详情',
        init_url:resUrl,
        submit_url:'payActive/findActiveById.do?id='+id,
        serviceName:'payActive'
    });
