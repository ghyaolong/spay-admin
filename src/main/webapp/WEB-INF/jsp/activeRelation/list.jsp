...
<head>
    <title></title>
    <script src="./js/activeRelation/list.js"></script>
</head>
<body>
<!--检索区 -->
    ...
    <div class="panel-body">
        <form class="form-inline" role="form" id="searchForm">
            <div class="form-group">
                <label class="sr-only" ></label>活动ID
                <input type="text" class="form-control" placeholder="请输入活动ID" name="activeId">
            </div> 
            <div class="form-group">
    ...
    <div class="table-responsive">
        <table class="table table-striped b-t b-light">
            ...
            <tr>
                ...
                <td>{$T.record.activeId}</td>
                <td>{$T.record.businessId}</td>
            </tr>
            {#/for}
            </tbody>
        </table>
